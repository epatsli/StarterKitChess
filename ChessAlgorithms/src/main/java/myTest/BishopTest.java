...
public class BishopTest {
	...
	public void shouldCheckMoveForBihop() throws InvalidMoveException {
		...
		assertEquals(false, b.checkMove(board, coordinateWhiteBishop, new Coordinate(6, 3)));
		assertEquals(false, b.checkMove(board, coordinateWhiteBishop, new Coordinate(7, 7)));
		...
		assertEquals(false, b.checkMove(board, coordinateBlackBishop, new Coordinate(0, 4)));
		assertEquals(false, b.checkMove(board, coordinateBlackBishop, new Coordinate(5, 3)));
		assertEquals(false, b.checkMove(board, coordinateBlackBishop, new Coordinate(0, 6)));
	}
